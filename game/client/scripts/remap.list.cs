...
$RemapName[15] = "";
$RemapCmd[15] = "pitch";
$RemapName[16] = "Trigger #0\tFire/Materialize\tFire";
...
$RemapName[21] = "Trigger #5\tCrouch\tCrouch";
...
$RemapName[34] = "Action #0\t0\t-";
$RemapCmd[34] = "action0";
$RemapName[35] = "Action #1\t1\t-";
$RemapCmd[35] = "action1";
$RemapName[36] = "Action #2\t2\t-";
$RemapCmd[36] = "action2";
$RemapName[37] = "Action #3\t3\t-";
$RemapCmd[37] = "action3";
$RemapName[38] = "Action #4\t4\t-";
$RemapCmd[38] = "action4";
$RemapName[39] = "Action #5\t5\t-";
$RemapCmd[39] = "action5";
$RemapName[40] = "Action #6\t6\t-";
$RemapCmd[40] = "action6";
$RemapName[41] = "Action #7\t7\t-";
$RemapCmd[41] = "action7";
$RemapName[42] = "Action #8\t8\t-";
$RemapCmd[42] = "action8";
$RemapName[43] = "Action #9\t9\t-";
$RemapCmd[43] = "action9";
$RemapName[44] = "Action #10\tDematerialize controlled form\t-";
$RemapCmd[44] = "action10";
$RemapName[45] = "Action #11\tEnter/leave form\t-";
$RemapCmd[45] = "action11";
$RemapName[46] = "Action #12\tCycle weapons\tCycle weapons";
$RemapCmd[46] = "action12";
$RemapName[47] = "Action #13\tReload weapon\t-";
$RemapCmd[47] = "action13";
$RemapName[48] = "Action #14\t-\t-";
$RemapCmd[48] = "action14";
$RemapName[49] = "Action #15\tMount/dismount vehicle-\t-";
$RemapCmd[49] = "action15";
$RemapName[50] = "Action #16\t-\t-";
$RemapCmd[50] = "action16";
$RemapName[51] = "Action #17\tDematerialize form(s)\t-";
