...
exec("./soldiercat.sfx.cs");
exec("./soldiercat.gfx.cs");
...
function RedInfantryCat::materialize(%this, %client, %pos, %normal, %transform)
{
//	if( %this.team == $Team1 )
		%data = RedInfantryCat;
//	else
...
function RedInfantryCat::dematerialize(%this, %obj)
{
