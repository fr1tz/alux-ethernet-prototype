...
datablock ShapeBaseImageData(WpnStyckImage)
{
	...
	usesEnergy = true;
	minEnergy = WpnStyckPseudoProjectile.energyDrain-1;

	projectile = WpnStyckPseudoProjectile;
	...
	crosshair = "blaster"; // crosshair to display when holding this weapon
 	fireprojectile[0] = WpnStyckProjectile;
   reloadTime = 800;
   reloadAmount = 100;
	...
	//
		...
		stateFire[3]                     = true;
		stateFireProjectile[3]           = WpnStyckPseudoProjectile;
