...
datablock ParticleData(WpnRedRaptorProjectileParticleEmitter_Particles)
{
	dragCoefficient      = 1;
...
datablock ParticleEmitterData(WpnRedRaptorProjectileParticleEmitter)
{
	ejectionPeriodMS = 10;
	periodVarianceMS = 2;
	ejectionVelocity = 5;
	...
	lifetimeMS		 = 0;
	particles = "WpnRedRaptorProjectileParticleEmitter_Particles";
};

//-----------------------------------------------------------------------------
// laser tail...

datablock LaserBeamData(WpnRedRaptorProjectileLaserTail)
{
	hasLine = true;
...
datablock MultiNodeLaserBeamData(WpnRedRaptorProjectileLaserTrail2)
{
	hasLine   = false;
...
datablock MultiNodeLaserBeamData(WpnRedRaptorProjectileLaserTrail)
{
	hasLine   = false;
	lineColor = "1.00 0.50 0.50 0.5";
	lineWidth = 2.0;
...
datablock ParticleData(WpnRedRaptorProjectileImpact_Smoke)
{
...
datablock ParticleEmitterData(WpnRedRaptorProjectileImpact_SmokeEmitter)
{
	ejectionOffset	= 0;
	...
	particles = "WpnRedRaptorProjectileImpact_Smoke";
};

datablock DebrisData(WpnRedRaptorProjectileImpact_Debris)
{
	// shape...
...
datablock ExplosionData(WpnRedRaptorProjectileImpact)
{
	...
	emitter[1] = WpnRedRaptorProjectileImpact_SmokeEmitter;

	//debris = WpnRedRaptorProjectileImpact_Debris;
	//debrisThetaMin = 0;
	//debrisThetaMax = 60;
	//debrisNum = 1;
	//debrisNumVariance = 1;
...
datablock ParticleData(WpnRedRaptorProjectileHit_Particle)
{
	dragCoefficient    = 0.0;
	windCoefficient    = 0.0;
	gravityCoefficient	= 0.0;
...
datablock ParticleEmitterData(WpnRedRaptorProjectileHit_Emitter)
{
	ejectionOffset	= 0;
	...
	particles = "WpnRedRaptorProjectileHit_Particle";
};

datablock ExplosionData(WpnRedRaptorProjectileHit)
{
	soundProfile = WpnRaptorProjectileImpactSound;

	lifetimeMS = 450;

	particleEmitter = WpnRedRaptorProjectileHit_Emitter;
	particleDensity = 1;
	particleRadius = 0;
...
datablock ExplosionData(WpnRedRaptorProjectileMissedEnemyEffect)
{
