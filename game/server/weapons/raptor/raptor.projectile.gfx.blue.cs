...
datablock LaserBeamData(WpnBlueRaptorProjectileLaserTail)
{
	hasLine = true;
...
datablock MultiNodeLaserBeamData(WpnBlueRaptorProjectileLaserTrail)
{
	hasLine = true;
...
datablock ParticleData(WpnBlueRaptorProjectileImpact_Smoke)
{
...
datablock ParticleEmitterData(WpnBlueRaptorProjectileImpact_SmokeEmitter)
{
	ejectionOffset	= 0;
	...
	particles = "WpnBlueRaptorProjectileImpact_Smoke";
};

datablock DebrisData(WpnBlueRaptorProjectileImpact_Debris)
{
	// shape...
...
datablock ExplosionData(WpnBlueRaptorProjectileImpact)
{
	...
	emitter[1] = WpnBlueRaptorProjectileImpact_SmokeEmitter;

	//debris = WpnBlueRaptorProjectileImpact_Debris;
	//debrisThetaMin = 0;
	//debrisThetaMax = 60;
	//debrisNum = 1;
	//debrisNumVariance = 1;
...
datablock ParticleData(WpnBlueRaptorProjectileHit_Particle)
{
	dragCoefficient    = 0.0;
	windCoefficient    = 0.0;
...
datablock ParticleEmitterData(WpnBlueRaptorProjectileHit_Emitter)
{
	ejectionOffset	= 0;
	...
	particles = "WpnBlueRaptorProjectileHit_Particle";
};

datablock ExplosionData(WpnBlueRaptorProjectileHit)
{
	soundProfile = WpnRaptorProjectileImpactSound;

	lifetimeMS = 450;

	particleEmitter = WpnBlueRaptorProjectileHit_Emitter;
	particleDensity = 1;
	particleRadius = 0;
...
datablock ExplosionData(WpnBlueRaptorProjectileMissedEnemyEffect)
{
