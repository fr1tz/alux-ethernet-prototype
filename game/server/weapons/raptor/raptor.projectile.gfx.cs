...
datablock ParticleData(WpnRaptorProjectileParticleEmitter_Particles)
{
	dragCoefficient      = 1;
...
datablock ParticleEmitterData(WpnRaptorProjectileParticleEmitter)
{
	ejectionPeriodMS = 10;
	periodVarianceMS = 2;
	ejectionVelocity = 5;
	...
	lifetimeMS		 = 0;
	particles = "WpnRaptorProjectileParticleEmitter_Particles";
};
