...
datablock ParticleData(WpnMinihawkProjectileParticleEmitter_Particles)
{
	dragCoefficient      = 1;
...
datablock ParticleEmitterData(WpnMinihawkProjectileParticleEmitter)
{
	ejectionPeriodMS = 10;
	periodVarianceMS = 2;
	ejectionVelocity = 5;
	...
	lifetimeMS		 = 0;
	particles = "WpnMinihawkProjectileParticleEmitter_Particles";
};
