...
datablock ParticleData(WpnBadgerFireEmitter_Particles)
{
	dragCoefficient       = 1;
...
datablock ParticleEmitterData(WpnBadgerFireEmitter)
{
	ejectionPeriodMS = 10;
	periodVarianceMS = 0;
	...
	lifetimeMS       = 0;
	particles        = "WpnBadgerFireEmitter_Particles";
};
...
datablock ShapeBaseImageData(WpnBadgerImage)
{
	...
	shapeFile = "share/shapes/alux/badger.image.dts";
	emap = true;
   ...
   eyeOffset   = "0.1 0.2 0.0";
	...
	usesEnergy = true;
	minEnergy = WpnBadgerProjectile.energyDrain-1;
   ...
   reloadTime = 2000;
	...
	//
		...
		stateFire[3]                     = true;
		stateFireProjectile[3]           = WpnBadgerProjectile;
...
function WpnBadgerImage::onMount(%this, %obj, %slot)
{
   ...
   // Set up HUD
   commandToClient(%client, 'Hud', "energy", true, "share/hud/alux/ammobar.universal.16.png");
