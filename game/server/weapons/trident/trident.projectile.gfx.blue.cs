...
datablock LaserBeamData(WpnBlueTridentProjectileLaserTail)
{
	hasLine = true;
...
datablock MultiNodeLaserBeamData(WpnBlueTridentProjectileLaserTrail)
{
	hasLine = true;
...
datablock ParticleData(WpnBlueTridentProjectileImpact_Smoke)
{
...
datablock ParticleEmitterData(WpnBlueTridentProjectileImpact_SmokeEmitter)
{
	ejectionOffset	= 0;
	...
	particles = "WpnBlueTridentProjectileImpact_Smoke";
};

datablock DebrisData(WpnBlueTridentProjectileImpact_Debris)
{
	// shape...
...
datablock ExplosionData(WpnBlueTridentProjectileImpact)
{
	...
	emitter[1] = WpnBlueTridentProjectileImpact_SmokeEmitter;

	//debris = WpnBlueTridentProjectileImpact_Debris;
	//debrisThetaMin = 0;
	//debrisThetaMax = 60;
	//debrisNum = 1;
	//debrisNumVariance = 1;
...
datablock ParticleData(WpnBlueTridentProjectileHit_Particle)
{
	dragCoefficient    = 0.0;
	windCoefficient    = 0.0;
...
datablock ParticleEmitterData(WpnBlueTridentProjectileHit_Emitter)
{
	ejectionOffset	= 0;
	...
	particles = "WpnBlueTridentProjectileHit_Particle";
};

datablock ExplosionData(WpnBlueTridentProjectileHit)
{
	soundProfile = WpnTridentProjectileImpactSound;

	lifetimeMS = 450;

	particleEmitter = WpnBlueTridentProjectileHit_Emitter;
	particleDensity = 1;
	particleRadius = 0;
...
datablock ExplosionData(WpnBlueTridentProjectileMissedEnemyEffect)
{
