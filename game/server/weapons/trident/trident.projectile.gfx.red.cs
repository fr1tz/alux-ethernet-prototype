...
datablock ParticleData(WpnRedTridentProjectileParticleEmitter_Particles)
{
	dragCoefficient      = 1;
...
datablock ParticleEmitterData(WpnRedTridentProjectileParticleEmitter)
{
	ejectionPeriodMS = 10;
	periodVarianceMS = 2;
	ejectionVelocity = 5;
	...
	lifetimeMS		 = 0;
	particles = "WpnRedTridentProjectileParticleEmitter_Particles";
};

//-----------------------------------------------------------------------------
// laser tail...

datablock LaserBeamData(WpnRedTridentProjectileLaserTail)
{
	hasLine = true;
...
datablock MultiNodeLaserBeamData(WpnRedTridentProjectileLaserTrail)
{
	hasLine = true;
...
datablock ParticleData(WpnRedTridentProjectileImpact_Smoke)
{
...
datablock ParticleEmitterData(WpnRedTridentProjectileImpact_SmokeEmitter)
{
	ejectionOffset	= 0;
	...
	particles = "WpnRedTridentProjectileImpact_Smoke";
};

datablock DebrisData(WpnRedTridentProjectileImpact_Debris)
{
	// shape...
...
datablock ExplosionData(WpnRedTridentProjectileImpact)
{
	...
	emitter[1] = WpnRedTridentProjectileImpact_SmokeEmitter;

	//debris = WpnRedTridentProjectileImpact_Debris;
	//debrisThetaMin = 0;
	//debrisThetaMax = 60;
	//debrisNum = 1;
	//debrisNumVariance = 1;
...
datablock ParticleData(WpnRedTridentProjectileHit_Particle)
{
	dragCoefficient    = 0.0;
	windCoefficient    = 0.0;
	gravityCoefficient	= 0.0;
...
datablock ParticleEmitterData(WpnRedTridentProjectileHit_Emitter)
{
	ejectionOffset	= 0;
	...
	particles = "WpnRedTridentProjectileHit_Particle";
};

datablock ExplosionData(WpnRedTridentProjectileHit)
{
	soundProfile = WpnTridentProjectileImpactSound;

	lifetimeMS = 450;

	particleEmitter = WpnRedTridentProjectileHit_Emitter;
	particleDensity = 1;
	particleRadius = 0;
...
datablock ExplosionData(WpnRedTridentProjectileMissedEnemyEffect)
{
